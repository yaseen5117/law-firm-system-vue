              ...
              <table class="table table-hover" v-if="isLoaded">
                ...
                <tbody>
                  ...
                  <tr v-if="contact_requests.length == 0">   
                      <td colspan="5" class="alert alert-warning text-center">No Records found.</td>                    
...
export default {
  ...
  methods: {    
    async getContactRequest() {
      ...
      axios
        .get(
          this.base_url + "/api/get_contact_requests",
          {headers}
        )
        .then((response) => {
    ...
    deleteContactRequest(contactRequestId, row_index) {
      if (confirm("Do you really want to delete?")) {
        ...
        axios
          .post(this.base_url + "/api/delete_contact_request/" + contactRequestId, {
            headers,
          })
          .then(
            (response) => {
