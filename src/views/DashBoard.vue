<template>
  <main id="main">
    ...
    <section id="services"  class="services section-bg dashboard-margin-top">
      ...
      <div class="container" v-if="this.user">
        <div class="row gy-4">
          <div v-if="this.user.is_admin || this.user.is_lawyer || this.user.is_student
            " :class="this.user.is_student ? 'disabled-dashboard-menu' : ''" v-on="this.user.is_student
    ? { click: () => studentModal() }
    ...
    " class="cursor-pointer col-lg-4 col-md-6 d-flex align-items-stretch" data-aos-delay="100">
          ...
          <div @click="gotoLink('petitions')" v-if="this.user"
    ...
    " :class="this.user.is_student ? 'disabled-dashboard-menu' : ''"
          ...
          <div @click="gotoLink('#')" v-if="(user.company_id == 1) &&
            ...
            <div class="icon-box iconbox-secret border">
              ...
              <h4>
                <router-link to="#">Corporate Law Guru (coming soon!)</router-link>
              </h4>
              <p>
    ...
    " :class="this.user.is_student ? 'disabled-dashboard-menu' : ''"
          ...
          <div v-on="this.user.is_student
            ...
            " v-if="(user.company_id == 1) &&
    this.user.is_admin || this.user.is_student" :class="this.user.is_student ? 'disabled-dashboard-menu' : ''"
            class="cursor-pointer col-lg-4 col-md-6 d-flex align-items-stretch">
    ...
    " class="cursor-pointer col-lg-4 col-md-6 d-flex align-items-stretch" data-aos-delay="200">
            <div class="icon-box fir-section-box border">
              ...
              <h4>
                <a target="_blank" v-on="this.user.is_student
                  ? { click: () => studentModal() }
                  : { click: () => gotoLink('fir-reader') }
                  ">Criminal Law Guru</a>
              </h4>
  ...
  <Dialog :dismissableMask="true" :modal="true" v-model:visible="displaymodal"
    :breakpoints="{ '960px': '75vw', '640px': '90vw' }" :style="{ width: '60vw' }">
    <template #header>
      <h4><i class="fa fa-ban fa-2xl forbidden-icon" /> Forbidden</h4>
    </template>
    <div class="confirmation-content">
      <span class="forbidden-text">This module is not available in the Student Version. Please contact us
