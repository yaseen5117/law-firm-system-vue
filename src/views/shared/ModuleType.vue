  ...
  <main id="" class="margintop85">
    ...
    <section id="services" class="services section-bg mt-3">
      ...
      <div class="container" data-aos="fade-up">
        <div class="row">
          <div
                            class="col-lg-3 col-md-3 col-sm-4 mb-3"                            
                          >
                            <select
                              class="form-select"
            ...
            <table class="table table-hover" v-if="isLoaded">
              ...
              <tbody>
                ...
                >
                  <td>
                    <span
                      ...
                      :key="module_type"
                    >
                      <span v-if="module_type.id == orderSheetType.module_id">
                        {{ module_type.title }}
                      </span>
                    </span>
                  </td>
                ...
                <tr>
                  <td colspan="">
                    <Dropdown
                      v-model="new_order_sheet.module_id"
                      ...
                      v-bind:class="{
                        'error-boarder': v$.new_order_sheet.module_id.$error,
                      }"
                      @blur="v$.new_order_sheet.module_id.$touch"
                    />
                    <span
                      v-if="v$.new_order_sheet.module_id.$error"
                      class="errorMessage"
                  ...
                  <td colspan="">
                    <input
                      class="form-control"
                      v-model="new_order_sheet.display_order"
                      v-on:keyup.enter="submitOrderSheetType()"
                    />
                  </td>
...
export default {
  ...
  methods: {
    getOrderSheetTypes() {
      ...
      axios
        .get(this.base_url + "/api/get_order_sheet_types", { headers,params: this.filters })
        .then((response) => {
    ...
    deleteOrderSheetType(OrderSheetTypeId, row_index) {
      if (confirm("Do you really want to delete?")) {
        ...
        axios
          .delete(
            this.base_url + "/api/delete_order_sheet_type/" + OrderSheetTypeId,
            {
              headers,
            }
          )
