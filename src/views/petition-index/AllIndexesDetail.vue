      ...
      <div class="container mt-2" data-aos="fade-up">
        <div class="row mb-2">
          ...
          <!-- <div class="col-lg-12 col-md-12 col-sm-12" v-show="showImgCard">
            <file-upload
              @afterUpload="getPetitionAnnexure"
          ...
          <div class="col-12">
            <div v-show="!horizontalView && !editView">
              <div
                ...
                v-for="(
                  petition_index_detail, detail_index
                ) in petition_index_details"
                :key="petition_index_detail.id"
              >
                <div
                  class="col-12"
                  v-for="(
                    attachment, index_attachment
                  ) in petition_index_detail.attachments"
                  :key="attachment"
...
export default {
  ...
  data() {
    return {
      ...
      id: this.$route.params.petition_id, //this is the id from the browser
    ...
    async getPetitionAnnexure() {
      ...
      await axios
        ...
        .then((response) => {
          ...
          this.petition_index_details = response.data.petition_details;
